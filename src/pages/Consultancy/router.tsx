...
export default function consultancyRouter() {
  return (
    <>
      <Route
        ...
        element={
          <Consultancy
            ...
            offeringsDesc="Our work is guided by a commitment to rigor, inclusivity, and local ownership, ensuring that our clients receive actionable insights grounded in evidence and shaped by the communities they aim to serve."
            offeringsEntries={[
            ...
            ctaHead="Let’s work together to turn data into action."
          />
        }
      />
      <Route
        ...
        element={
          <Consultancy
            ...
            offeringsTitle="Program Areas"
            offeringsDesc="Our consultancy training covers a wide range of technical and professional skill areas, including:"
            offeringsEntries={[
            ...
            ctaHead="Let’s build your team’s capacity, co-create a training that meets your organization’s needs."
          />
        }
      />
    </>
