...
export default function ourTeamRoutes() {
  return (
    <>
      {/* Management */}
      <Route
        path={routes.ourTeamDrAyo}
        element={
          <Bio
